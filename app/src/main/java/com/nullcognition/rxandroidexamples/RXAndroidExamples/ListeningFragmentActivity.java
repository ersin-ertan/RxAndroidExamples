...
public class ListeningFragmentActivity extends Activity {
   ...
   protected void onCreate(Bundle savedInstanceState){
	  ...
	  setContentView(R.layout.activity_listening_fragment);
   }
   ...
   public static class ListeningFragment extends Fragment {
	  ...
	  public void onCreate(Bundle savedInstanceState){
		 ...
		 strings = SampleObservables.numberStrings(1, 50, 250)
									.publish();
	  ...
	  public void onViewCreated(final View view, Bundle savedInstanceState){
		 ...
		 subscription = AppObservable.bindFragment(this, strings)
